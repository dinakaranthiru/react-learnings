    ...
    <div className="demo-container">
      <div className="demo-card" style={{ maxWidth: "520px", margin: "0 auto" }}>
        <div className="demo-header" style={{ textAlign: "center", alignItems: "center" }}>
          <span className="demo-badge demo-badge-purple">Component Props</span>
          <h1 className="demo-title">Props Demonstration</h1>
          <p className="demo-desc">
            Passing immutable read-only parameters from parent to child component.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              <div style={{ fontSize: "0.75rem", color: "#94a3b8" }}>Name Prop</div>
            ...
            >
              <div style={{ fontSize: "0.75rem", color: "#94a3b8" }}>Age Prop</div>
        ...
        >
          ...
          <span style={{ color: "#38bdf8" }}>Props</span>{" "}
